...
> Answer: Client-side routing allows the developer to "fake" a multi-page application for the user but loads the information all at once at the beginning instead of everytime the user interacts with the page.
